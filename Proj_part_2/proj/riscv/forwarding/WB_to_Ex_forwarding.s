...
main:
    ...
    # I1: PRODUCER (Load)
    lw x1, 0(sp)           # I1: x1 = 5 (Result ready at end of MEM stage, written in WB)
    ...
    jalr x0, 0(x6)         # I7: Spacer 2 (Unconditional jump/return)
